...
## Screenshot
1. ![Added panel for More excerpt options](https://github.com/tiptoppress/term-posts-excerpt-extension/blob/master/screenshot-1.PNG?raw=true "Added panel for More excerpt options")
